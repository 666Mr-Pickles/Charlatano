...
fun netVar(className: String, varName: String? = null, offset: Int = 0, index: Int = -1) = NetVar(className, if (varName != null && index >= 0) "$varName[$index]" else varName, offset, index)